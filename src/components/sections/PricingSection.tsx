...
interface PricingSectionProps {
  ...
  /** Default tab to show */
  defaultTab?: "autonomos" | "pymes" | "gestoria";
}

export default function PricingSection({ variant = "hero", defaultTab = "autonomos" }: PricingSectionProps) {
  const t = useTranslations("pricingPage");
  const params = useParams();
  const locale = params.locale as string;
  const [activeTab, setActiveTab] = useState<"autonomos" | "pymes" | "gestoria">(defaultTab);
