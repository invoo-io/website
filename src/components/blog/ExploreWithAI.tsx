...
export default function ExploreWithAI({
  ...
  return (
    <div className="flex items-center justify-between gap-4 bg-background-secondary rounded-xxl p-4 mt-8 border border-border-primary">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-subheadline text-primary">
