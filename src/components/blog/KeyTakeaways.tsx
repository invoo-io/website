...
export default function KeyTakeaways({ takeaways }: KeyTakeawaysProps) {
  ...
  return (
    <div className="bg-bg-secondary rounded-xxl p-6 mt-4 mb-8 border border-border-primary">
      {/* Header */}
      ...
      <ul className="space-y-3">
        {takeaways.map((takeaway, index) => (
          <li
            key={index}
            className="flex items-start gap-3 text-subheadline text-text-secondary"
          >
