...
export async function generateMetadata({
  ...
  const esPath = ensureTrailingSlash('/es/herramientas/calculadoras/factura');
  const enPath = ensureTrailingSlash('/en/tools/calculators/invoice');
  ...
  return {
    ...
    twitter: {
      ...
      title: t('meta.title'),
      description: t('meta.description'),
      images: [`${BASE_URL}/og/calculators/factura.png`],
    },
    keywords: [
      'calculadora factura',
      'calcular IVA IRPF factura',
      'factura con impuestos',
      'calculadora factura autónomos',
      'IVA IRPF España',
      'generar factura online',
    ],
  };
}
  ...
  const relatedCalculators = [
    {
      ...
      href: getBasePath(`/${locale}/herramientas/calculadoras/iva`),
