...
export async function generateMetadata({
  ...
  const esPath = ensureTrailingSlash('/es/herramientas/calculadoras/gastos-deducibles');
  const enPath = ensureTrailingSlash('/en/tools/calculators/deductible-expenses');
  ...
  return {
    ...
    openGraph: {
      ...
      description: t('meta.description'),
      images: [{
        url: `${BASE_URL}/og/calculators/gastos-deducibles.png`,
        width: 1200,
        height: 630,
        alt: t('meta.title'),
        type: 'image/png',
    ...
    twitter: {
      ...
      title: t('meta.title'),
      description: t('meta.description'),
      images: [`${BASE_URL}/og/calculators/gastos-deducibles.png`],
      creator: '@invoo_es',
      site: '@invoo_es',
    },
    keywords: [
      'gastos deducibles autónomos',
      'qué puedo deducir autónomo',
      'IVA deducible',
      'IRPF deducible',
      'GDJ autónomos',
...
export default async function GastosDeduciblesCalculatorPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const relatedCalculators = [
    ...
    },
    {
      ...
      href: getBasePath(`/${locale}/herramientas/calculadoras/modelo-303`),
  ...
  const calculatorSchema = generateCalculatorSchema({
    ...
    features: [
      'Cálculo de IVA recuperable por categoría',
      'Gastos deducibles en IRPF',
      'GDJ automático (5%, máx. 2000€)',
  ...
  const breadcrumbSchema = generateCalculatorBreadcrumbSchema({
    ...
    calculatorSlug: 'gastos-deducibles',
  });
