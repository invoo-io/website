...
export async function generateMetadata({
  ...
  const esPath = ensureTrailingSlash('/es/herramientas/calculadoras/modelo-303');
  const enPath = ensureTrailingSlash('/en/tools/calculators/vat-return');
...
export default async function Modelo303CalculatorPage({
  ...
  const relatedCalculators = [
    ...
    },
    {
      ...
      href: getBasePath(`/${locale}/herramientas/calculadoras/modelo-130`),
