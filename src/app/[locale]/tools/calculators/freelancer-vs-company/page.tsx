...
const DynamicAutonomoVsEmpresaCalculator = dynamicImport(
  () => import('@/components/calculators/pages/AutonomoVsEmpresaCalculatorPage').then(mod => mod.AutonomoVsEmpresaCalculatorPageContent),
  {
    loading: () => (
...
export async function generateMetadata({
  ...
  const esPath = ensureTrailingSlash('/es/herramientas/calculadoras/autonomo-vs-empresa');
  const enPath = ensureTrailingSlash('/en/tools/calculators/freelancer-vs-company');
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background-primary">
        ...
        {/* 1. Hero + Calculator */}
        <DynamicAutonomoVsEmpresaCalculator />

        {/* 2. How To Use - bg-secondary */}
        <div className="bg-background-secondary">
          <FourPillarSection
            locale={locale}
            translationKey="calculators.autonomoVsEmpresa.howTo"
        ...
        <FourPillarSection
          locale={locale}
          translationKey="calculators.autonomoVsEmpresa.concepts"
          pillars={[
            {
              key: 'autonomo',
              icon: 'User',
        ...
        <ThreeCardSection
          locale={locale}
          translationKey="calculators.autonomoVsEmpresa.benefitsCards"
          cardBackground="tertiary"
          cards={[
            {
              key: 'card1',
        ...
        {/* 5. FAQ - bg-primary */}
        <FAQSection
          titleKey="calculators.autonomoVsEmpresa.faqTitle"
          titleHighlightKey="calculators.autonomoVsEmpresa.faqTitleHighlight"
          questionsKey="calculators.autonomoVsEmpresa.faq"
          background="primary"
        />
        ...
        <FinalCTASection
          locale={locale}
          translationKey="calculators.autonomoVsEmpresa.finalCta"
        />
