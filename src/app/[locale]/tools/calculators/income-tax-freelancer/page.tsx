...
export async function generateMetadata({
  ...
  const esPath = ensureTrailingSlash('/es/herramientas/calculadoras/irpf-autonomos');
  const enPath = ensureTrailingSlash('/en/tools/calculators/income-tax-freelancer');

  return {
    title: t('meta.title'),
    description: t('meta.description'),
    keywords: ['income tax calculator', 'IRPF Spain', 'freelancer tax calculator', 'Spanish income tax', 'IRPF autonomos', 'tax brackets Spain', 'self-employed tax'],
    alternates: {
...
export default async function IncomeTaxFreelancerCalculatorPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const relatedCalculators = [
    ...
    },
    {
      ...
      href: getBasePath(`/${locale}/tools/calculators/self-employed-quota`),
  ...
  const calculatorSchema = generateCalculatorSchema({
    ...
    name: t('meta.title'),
    description: t('meta.description'),
    slug: 'income-tax-freelancer',
    features: [
      'Real-time income tax calculation for freelancers',
      'Tax brackets for 2024, 2025, and 2026',
      'Includes personal and family minimums',
      'Automatic difficult-to-justify expenses',
      'Instant results',
    ],
  });
  ...
  const breadcrumbSchema = generateCalculatorBreadcrumbSchema({
    ...
    calculatorSlug: 'income-tax-freelancer',
  });
    ...
    <>
      ...
      <div className="min-h-screen bg-background-primary">
        ...
        <div className="bg-background-secondary">
          <FourPillarSection
            locale={locale}
            translationKey="calculators.irpfAutonomos.howTo"
        ...
        {/* 3. Tax Brackets - bg-primary */}
        <FourPillarSection
          locale={locale}
          translationKey="calculators.irpfAutonomos.tramos"
          pillars={[
            {
              key: 'pillar1',
              icon: 'TrendingDown',
        ...
        <ThreeCardSection
          locale={locale}
          translationKey="calculators.irpfAutonomos.benefits"
          cardBackground="tertiary"
          cards={[
            {
              key: 'card1',
        ...
        {/* 5. FAQ - bg-primary */}
        <FAQSection
          titleKey="calculators.irpfAutonomos.faqTitle"
          titleHighlightKey="calculators.irpfAutonomos.faqTitleHighlight"
          questionsKey="calculators.irpfAutonomos.faq"
          background="primary"
        />
        ...
        <FinalCTASection
          locale={locale}
          translationKey="calculators.irpfAutonomos.finalCta"
        />
