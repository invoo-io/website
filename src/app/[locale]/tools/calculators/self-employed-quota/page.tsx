...
export async function generateMetadata({
  ...
  return {
    ...
    keywords: ['self-employed quota', 'Spanish social security', 'autonomo quota calculator', 'cuota autonomos', 'flat rate Spain', 'freelancer social security', 'Spain self-employed'],
    alternates: {
