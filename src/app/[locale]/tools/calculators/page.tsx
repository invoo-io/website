...
const calculatorIcons: Record<string, React.ComponentType<{ className?: string }>> = {
  'vat': Calculator,
  'self-employed-quota': TrendingUp,
  'invoice': FileText,
  'income-tax-freelancer': Receipt,
  'net-salary-freelancer': Banknote,
  'hourly-rate': Clock,
  'vat-return': FileText,
  'form-130': Receipt,
  'deductible-expenses': PiggyBank,
  'freelancer-vs-company': Scale,
};
...
export default async function CalculatorsHubPage({
  ...
  // Build calculator list from translations with English slugs
  const calculatorData = [
    { slug: 'vat', key: 'iva' },
    { slug: 'self-employed-quota', key: 'cuotaAutonomos' },
    { slug: 'invoice', key: 'factura' },
    { slug: 'income-tax-freelancer', key: 'irpfAutonomos' },
    { slug: 'net-salary-freelancer', key: 'sueldoNetoAutonomo' },
    { slug: 'hourly-rate', key: 'precioHora' },
    { slug: 'vat-return', key: 'modelo303' },
    { slug: 'form-130', key: 'modelo130' },
    { slug: 'deductible-expenses', key: 'gastosDeducibles' },
    { slug: 'freelancer-vs-company', key: 'autonomoVsEmpresa' },
  ];

  const calculators = calculatorData.map(({ slug, key }) => ({
