...
export async function generateMetadata({
  ...
  return {
    ...
    keywords: ['form 130', 'modelo 130 calculator', 'IRPF quarterly payment', 'Spanish tax return', 'freelancer quarterly tax', 'AEAT form 130', 'advance payment IRPF'],
    alternates: {
...
export default async function Form130CalculatorPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const calculatorSchema = generateCalculatorSchema({
    ...
    slug: 'form-130',
    features: [
      'Quarterly IRPF advance payment calculation',
      'Accumulated net income',
      'Previous payment deductions',
      'Invoice retentions',
      'Exemption detection',
    ],
  });
