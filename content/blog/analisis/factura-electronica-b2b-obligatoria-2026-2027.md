...
sources:
  ...
  - name: "AEAT - Sistemas Informáticos de Facturación (Verifactu)"
    url: "https://sede.agenciatributaria.gob.es/Sede/iva/sistemas-informaticos-facturacion-verifactu.html"
  - name: "BOE - RDL 15/2025 (ampliación plazos Verifactu)"
    url: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-24446"
  - name: "Ministerio de Economía - Borrador Reglamento Factura Electrónica B2B"
    url: "https://portal.mineco.gob.es/es-es/ministerio/participacionpublica/audienciapublica/Paginas/ECO_Pol_AP_20230619_RD_factura_electronica.aspx"
  - name: "Cuatrecasas - Análisis del nuevo borrador de reglamento"
    url: "https://www.cuatrecasas.com/es/spain/fiscalidad/art/reglamento-facturacion-electronica-nuevo-proyecto"
...
La factura electrónica B2B, regulada por la [Ley 18/2022](https://www.boe.es/buscar/act.php?id=BOE-A-2022-15818), es otra cosa. **Regula el intercambio de documentos entre empresarios y profesionales.** No le importa tanto tu software interno, sino el formato en que envías y recibes facturas de otras empresas: un formato estructurado, legible por máquinas, que elimina el PDF manual. Su objetivo es reducir la morosidad comercial, no combatir el fraude.
...
Si ya leíste [nuestra guía completa de Verifactu](/es/blog/guias/verifactu-2025-2026-guia-completa-autonomos-pymes/), tienes cubierta la primera parte. Este artículo se centra en la segunda: la factura electrónica B2B y lo que realmente te espera.

---

## Qué obliga exactamente la Ley Crea y Crece (Ley 18/2022)

La [Ley 18/2022 de Creación y Crecimiento de Empresas](https://www.boe.es/buscar/act.php?id=BOE-A-2022-15818) modifica la Ley 56/2007 para extender la obligación de factura electrónica más allá del sector público. Hasta ahora, la factura electrónica solo era obligatoria con la Administración Pública. Desde la Ley Crea y Crece, la obligación se extiende a **todas las operaciones entre empresarios y profesionales**.
...
Esto contrasta con Verifactu, donde las fechas sí son firmes gracias al RDL 15/2025: **1 de enero de 2027 para sociedades** (IS) y **1 de julio de 2027 para autónomos** (IRPF). Si quieres profundizar en esas fechas y lo que cambian, lee [las nuevas fechas de Verifactu aplazado a 2027](/es/blog/guias/verifactu-aplazado-2027-que-cambia-autonomos/).
...
5. **Registro de estado del documento**: el sistema debe permitir que el receptor confirme la recepción, aceptación o rechazo de la factura en plazos determinados.
...
La buena noticia: **no hay que hacer nada urgente hoy** para cumplir con la factura electrónica B2B. El reglamento sigue pendiente, y los plazos de adaptación empezarán a correr solo a partir de su publicación. Gastar dinero en adaptarse antes de que existan especificaciones técnicas definitivas sería precipitado.
...
<AccordionGroupItem title="¿Cuál es la diferencia entre Verifactu y la factura electrónica B2B?" value="faq-1">

Son dos obligaciones completamente independientes. **Verifactu** regula los requisitos de tu software de facturación: código QR, hash encadenado e inalterable, y la posibilidad de remitir datos a la AEAT. Su base legal es la Ley Antifraude (Ley 11/2021) y el RD 1007/2023.

**La factura electrónica B2B**, regulada por la Ley Crea y Crece (Ley 18/2022), obliga a intercambiar facturas en formato estructurado con otras empresas y profesionales. Su objetivo es reducir la morosidad comercial, no combatir el fraude fiscal.

Tienen calendarios distintos, bases legales distintas y sanciones distintas. Puedes estar obligado por una, por las dos, o por ninguna, dependiendo de tu perfil.
...
<AccordionGroupItem title="¿La factura electrónica B2B obliga a las facturas con particulares?" value="faq-3">

No. **La Ley Crea y Crece solo aplica a operaciones B2B**: entre empresarios y profesionales. Las facturas emitidas a consumidores finales (particulares) quedan completamente excluidas de esta obligación.

Si eres un autónomo que factura exclusivamente a particulares —un electricista que solo trabaja para hogares, por ejemplo—, la Ley Crea y Crece no te afecta. Si tienes una mezcla de clientes empresa y particulares, solo las facturas a las empresas entrarán en el ámbito de la norma.
