---
title: "Baja como Autónomo 2026: Trámites, Plazos y Prestación Cese"
excerpt: "Baja en Seguridad Social y Hacienda en 3 días. Trámites exactos, Modelo 036 y prestación por cese: requisitos, cuantía y duración explicados paso a paso."
publishedAt: "2026-03-05"
author: "Equipo Invoo"
tags: ["baja-autonomo", "prestacion-cese-actividad", "seguridad-social", "modelo-036", "tramites-autonomo"]
readingTime: 11
featured: false
editorPick: false
coverImage: "/blog/baja-autonomo-como-cuando-prestacion-cese.webp"
keyTakeaways:
...
sources:
  - name: "Seguridad Social - Baja en el trabajo por cuenta propia (Import@ss)"
    url: "https://portal.seg-social.gob.es/wps/portal/importass/importass/Categorias/Altas,+bajas+y+modificaciones/Bajas+y+modificaciones/Baja_trabajo_autonomo"
  - name: "AEAT - Procedimiento Modelo 036 (G322)"
  ...
  - name: "BOE - Real Decreto-Ley 13/2022 (cese de actividad)"
    url: "https://www.boe.es/buscar/act.php?id=BOE-A-2022-12482"
  - name: "UATAE - Estadísticas bajas RETA 2025"
    url: "https://uatae.org/mas-de-400-000-bajas-en-el-reta-en-2025-y-solo-6-400-autonomos-accedieron-al-paro/"
lastVerified: "Marzo 2026"
faq:
  - question: "¿Cuánto tiempo tengo para darme de baja como autónomo?"
    answer: "3 días naturales desde el cese en la Seguridad Social (RETA). Si te pasas del plazo, sigues generando cuotas hasta la fecha en que presentes la solicitud — no existe multa directa por el retraso, pero el coste puede ser considerable. Para Hacienda (Modelo 036) tienes 1 mes desde el día siguiente al cese."
  - question: "¿Cuánto se cobra con la prestación por cese de actividad?"
    answer: "El 70% de la base reguladora, calculada como la media de las bases de cotización de los 12 meses anteriores al cese. El mínimo es 560€/mes para autónomos sin hijos (80% del IPREM mensual incrementado en 1/6: 80% de 700€), y el máximo es 1.225€/mes (175% de esa misma base). La duración varía entre 4 y 24 meses según los meses cotizados."
  - question: "¿Puedo darme de baja como autónomo sin perder la prestación?"
    answer: "Solo si el cese es involuntario con causa justificada y documentada. Causas válidas: pérdidas superiores al 10% de los ingresos, ejecuciones judiciales que afecten más del 30% de los ingresos, concurso de acreedores, pérdida de licencia, fuerza mayor o violencia de género. El cese voluntario sin justificación no da derecho a prestación."
  - question: "¿Tengo que presentar impuestos después de darme de baja?"
    answer: "Sí. Debes presentar el Modelo 303 (IVA) y el Modelo 130 (IRPF) correspondientes al trimestre en que cesaste la actividad, con las operaciones hasta la fecha de baja. Además, tendrás que incluir los rendimientos de la actividad en tu declaración anual de IRPF del año del cese."
  - question: "¿Puedo volver a darme de alta después de la baja?"
    answer: "Sí, sin límite de veces y sin periodo mínimo de espera — puedes darte de alta al día siguiente. Pero si quieres acceder de nuevo a la tarifa plana de autónomos, necesitas haber estado de baja al menos 2 años (3 años si ya la usaste anteriormente). Si te das de baja durante el periodo de tarifa plana, la pierdes."
---
...
El trámite se hace a través de **[Import@ss](https://portal.seg-social.gob.es/wps/portal/importass/importass/Categorias/Altas,+bajas+y+modificaciones/Bajas+y+modificaciones/Baja_trabajo_autonomo)**, el portal de la Seguridad Social. Necesitas identificación digital: Cl@ve, certificado electrónico o DNI electrónico. No puedes hacerlo sin identificación digital — si no tienes ninguna de las tres, tendrás que ir presencialmente a la Tesorería General de la Seguridad Social.
...
Para entender cómo te afecta la [tabla de tramos y cuotas 2026](/es/blog/guias/tramos-cuota-autonomos-2026-tabla-completa/) antes y después de una baja, te recomendamos revisar los datos actualizados con los tramos vigentes.
...
Darse de alta de nuevo es sencillo: el proceso inverso al de la baja, también a través de Import@ss y la AEAT. **No hay periodo mínimo de espera** — puedes darte de alta al día siguiente de la baja si lo necesitas. Para revisar el proceso completo, nuestra guía sobre [cómo darte de alta como autónomo](/es/blog/guias/como-darse-alta-autonomo-2026-guia-paso-paso/) cubre todos los pasos actualizados para 2026.

Lo que sí cambia al reiniciarte es el acceso a beneficios. La tarifa plana requiere 2 años de baja (3 si ya la usaste), y en algunas comunidades autónomas puedes acceder a la [cuota cero en tu comunidad autónoma](/es/blog/guias/cuota-cero-autonomos-2026-comunidades-requisitos/) como alternativa mientras esperas cumplir el plazo para la tarifa plana estatal.

La [base de cotización y cómo elegirla](/es/blog/guias/elegir-base-cotizacion-autonomos-2026/) es otra decisión relevante al reiniciarte: puedes ajustar tu base a la baja si prevés ingresos menores durante la etapa inicial, y así reducir las [cuotas de autónomos 2026](/es/blog/guias/cuotas-autonomos-2026-guia-completa/) mientras reconstruyes la cartera de clientes.

---

**¿Vas a retomar tu actividad después de una baja?**

Con Invoo, arrancas desde el primer día con toda la facturación en orden: Verifactu incluido, tu gestoría conectada en tiempo real y sin curva de aprendizaje. Sin configuraciones complicadas ni plazos que se te escapen.
