...
author: "Equipo Invoo"
tags: ["irpf", "retenciones", "facturacion", "autonomos", "fiscalidad"]
readingTime: 12
featured: false
editorPick: false
...
Si alguna vez te has sentido como Sara, no estás solo. La retención del IRPF es uno de los conceptos que más confusión genera entre los autónomos españoles. No porque sea difícil, sino porque nadie te lo explica con claridad desde el principio.
...
## Qué es la retención del IRPF y por qué existe
...
Imagina que facturas 1.000€ a una empresa. Esa empresa, antes de pagarte, se queda con una parte (por ejemplo, 150€) y se la entrega directamente a Hacienda en tu nombre. Eso es la retención: un anticipo de tu Impuesto sobre la Renta de las Personas Físicas (IRPF) que tu cliente ingresa por ti.
...
En estos casos sin retención, tú cobras el importe íntegro, pero eso no significa que no debas pagar IRPF. Simplemente lo harás tú mismo a través del [Modelo 130 de pagos fraccionados](/es/blog/guias/modelo-303-vs-modelo-130-guia-autonomos/).

### Quién declara la retención (spoiler: no eres tú)

Aquí hay una confusión muy común. Tú no declaras ni ingresas la retención que te aplican. Eso lo hace tu cliente. Es tu cliente quien presenta trimestralmente el **Modelo 111** (donde declara todas las retenciones que ha practicado) y anualmente el **Modelo 190** (resumen informativo del año).
...
Este porcentaje está regulado en el artículo 95 del [Reglamento del IRPF (Real Decreto 439/2007)](https://www.boe.es/buscar/act.php?id=BOE-A-2007-6820) y se aplica sobre la base imponible de tu factura (tus honorarios, sin IVA).
...
Desde enero de 2023 ([Real Decreto 31/2023](https://www.boe.es/diario_boe/txt.php?id=BOE-A-2023-2023)), ciertos profesionales de actividades artísticas y culturales pueden aplicar el 7% de retención si cumplen **dos condiciones acumulativas**:
...
## Cómo calcular la retención en tu factura (paso a paso)
...
La base imponible es el importe de tus servicios sin impuestos: 2.000€

**Paso 2: Calcular el IVA**
La mayoría de servicios profesionales tributan al 21%:
2.000€ × 21% = 420€

**Paso 3: Calcular la retención IRPF**
La retención se aplica sobre la base imponible, no sobre el total con IVA:
2.000€ × 15% = 300€

**Paso 4: Total a cobrar**
Base imponible + IVA - Retención IRPF:
2.000€ + 420€ - 300€ = **2.120€**
...
Es el error más frecuente y el que más problemas causa. Muchos nuevos autónomos simplemente ponen el 7% en sus facturas pensando que es automático. No lo es. Sin la comunicación escrita, tu cliente puede (y en muchos casos debe) aplicarte el 15%.
...
La retención es un pago a cuenta. No es el impuesto definitivo que vas a pagar. Muchos autónomos piensan que si les retienen el 15%, ya han pagado el 15% de IRPF. No es así. El IRPF real que pagas depende de tus ingresos totales anuales y puede ser mayor o menor que lo retenido.
...
Para más errores comunes de autónomos principiantes, consulta nuestra guía sobre [5 errores comunes de autónomos principiantes](/es/blog/consejos/5-errores-comunes-autonomos-principiantes/).
...
## Checklist: ¿Qué retención aplico?

Antes de emitir cada factura, sigue este árbol de decisión:
...
**¿Puedo aplicar el 7% si en 2024 trabajé por cuenta ajena y en 2025 me hago autónomo?**

Sí. El requisito es no haber ejercido "actividad profesional" (autónomo) el año anterior. El trabajo por cuenta ajena no cuenta. Si en 2024 eras empleado y en 2025 te das de alta como autónomo profesional, puedes aplicar el 7%.

**¿Y si me di de alta como autónomo en 2024 pero solo un mes y luego me di de baja?**

No puedes aplicar el 7% en 2025. El requisito es claro: no haber ejercido "ninguna" actividad profesional el año anterior. Un mes es suficiente para descalificarte.

**¿Qué pasa si me olvido de pasar del 7% al 15% cuando me toque?**

Si sigues aplicando el 7% cuando ya no tienes derecho, tu cliente puede tener problemas con Hacienda si se detecta en una inspección. La responsabilidad de retener correctamente es del pagador (tu cliente), pero tú le estarías induciendo a error. Además, te habrán retenido menos de lo debido y tendrás que pagar más en la declaración de la renta.

**¿La retención afecta a lo que declaro en el Modelo 303 (IVA)?**

No. El Modelo 303 es de IVA y la retención es de IRPF. Son impuestos completamente separados. El IVA que declaras en el 303 no tiene nada que ver con las retenciones que te aplican o que aplicas a otros.

**¿Cómo afecta Verifactu a las retenciones?**

[Verifactu](/es/blog/guias/verifactu-2025-2026-guia-completa-autonomos-pymes/) es el sistema de facturación electrónica que será obligatorio desde 2026. Afecta a cómo emites tus facturas (QR obligatorio, software certificado), pero **NO cambia los porcentajes ni las reglas de retención**. Seguirás aplicando 7% o 15% exactamente igual que ahora.

**¿Mi gestoría necesita algo especial para declarar mis retenciones?**

Tu gestoría necesita saber qué retenciones te han aplicado durante el año para incluirlas en tu declaración de la renta. Con [Invoo](https://invoo.es), tus facturas salen con Verifactu QR desde el primer día y puedes exportar CSV/PDF por trimestre con todas las retenciones desglosadas. Tu gestoría tiene acceso en tiempo real sin perseguirte por datos.

---

## Lo que Invoo hace por ti

Configurar correctamente las retenciones cliente a cliente puede ser tedioso si usas plantillas de Excel o Word. Un error de porcentaje y tienes que rehacer la factura.

Con Invoo, configuras el tipo de retención una vez por cliente y queda guardado. Cada factura que emitas a ese cliente tendrá el porcentaje correcto automáticamente. Si cambias de 7% a 15%, actualizas el cliente y listo.

Además:

- **Cálculo automático:** Introduces tu base imponible, seleccionas IVA y retención, e Invoo calcula el total a cobrar sin errores
- **PDF con QR Verifactu:** Tus facturas ya cumplen con la normativa que será obligatoria desde julio 2026
- **Exportación para gestoría:** CSV y PDF por trimestre con retenciones desglosadas
- **Control de deducibles:** Aprovecha las [15 deducciones fiscales que te corresponden como autónomo](/es/blog/consejos/15-deducciones-fiscales-autonomos-espana/)

---

## Conclusión

La retención del IRPF no es complicada cuando entiendes las reglas básicas. El 15% es el tipo general para profesionales. El 7% es para nuevos profesionales durante 3 años, siempre que no hayas ejercido el año anterior y lo comuniques por escrito a cada cliente.

Lo más importante que puedes hacer es:

1. Comunicar correctamente tu situación a cada cliente
2. Reflejar el porcentaje adecuado en cada factura
3. Saber cuándo cambia tu tipo y actuar en consecuencia
4. Usar herramientas que te ayuden a no cometer errores

La retención es solo un anticipo. Lo que te retengan de más, te lo devuelven. Lo que te retengan de menos, lo pagas después. El sistema funciona si haces las cosas bien desde el principio.

---

**¿Quieres simplificar tu facturación y tener las retenciones siempre bajo control?**
