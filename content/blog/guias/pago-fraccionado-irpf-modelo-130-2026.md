---
title: "Modelo 130: Cuánto Pagar Cada Trimestre (con Ejemplos)"
excerpt: "Aprende a calcular el Modelo 130 paso a paso: fórmula del 20%, ejemplos reales trimestre a trimestre y cómo rellenarlo sin errores. Guía 2026."
publishedAt: "2026-02-24"
author: "Equipo Invoo"
tags: ["modelo-130", "pago-fraccionado", "irpf-autonomos", "impuestos-trimestrales", "estimacion-directa"]
readingTime: 12
featured: false
editorPick: false
coverImage: "/blog/modelo-130-pago-fraccionado-irpf.webp"
keyTakeaways:
...
faq:
  - question: "¿Cuánto se paga en el Modelo 130?"
    answer: "El 20% de tu rendimiento neto acumulado desde enero hasta el último día del trimestre, restando retenciones soportadas y pagos fraccionados de trimestres anteriores."
  - question: "¿Tengo que presentar el Modelo 130 si no he facturado nada?"
    answer: "Sí, si estás en estimación directa y no cumples la exención del 70% de retenciones. Debes presentar el modelo aunque el resultado sea cero."
  - question: "¿Qué pasa si el Modelo 130 sale negativo?"
    answer: "No pagas nada ese trimestre, pero debes presentar el modelo igualmente. El saldo negativo se arrastra al siguiente trimestre."
  - question: "¿Quién no tiene que presentar el Modelo 130?"
    answer: "Los profesionales cuyo 70% de ingresos del año anterior ya tuviera retención de IRPF. Ojo: esta exención no aplica a actividades empresariales."
  - question: "¿El Modelo 130 se calcula solo del trimestre o del año entero?"
    answer: "Del año entero acumulado. En el segundo trimestre calculas enero-junio completo y restas lo que ya pagaste en el primero."
sources:
  - name: "AEAT - Instrucciones del Modelo 130"
    url: "https://sede.agenciatributaria.gob.es/Sede/irpf/retenciones-ingresos-cuenta-pagos-fraccionados/pagos-fraccionados.html"
  - name: "AEAT - Pagos fraccionados: obligados y plazos"
    url: "https://sede.agenciatributaria.gob.es/Sede/procedimientoini/G601.shtml"
  - name: "BOE - Real Decreto 439/2007, artículo 110 (pagos fraccionados, estimación directa)"
...
1. Estás en **estimación directa** (normal o simplificada)
2. **Menos del 70%** de tus ingresos del año anterior tenía retención de IRPF
...
Para entender [la diferencia entre el Modelo 130 y el Modelo 303](/es/blog/guias/modelo-303-vs-modelo-130-guia-autonomos/), consulta nuestra guía dedicada: son impuestos completamente distintos que a menudo confunden a los autónomos.
...
<InfoCard variant="warning" title="Exención del 70%: solo para profesionales">
...
Aquí entran todos tus [gastos deducibles](/es/blog/guias/gastos-deducibles-autonomos-2026-lista-completa/) debidamente justificados con factura. La cuota mensual de autónomo es **100% deducible** como gasto de actividad —desde €80/mes con tarifa plana hasta unos €590/mes en el tramo más alto (cotizando por base mínima). Es un gasto relevante que reduce directamente lo que pagas.

Para entender qué gastos puedes incluir y con qué requisitos, la [guía de rendimientos netos para autónomos](/es/blog/formacion/rendimientos-netos-autonomos-como-calcular/) lo explica en detalle.

### Las retenciones soportadas (Casilla 05)

Si tienes clientes que te aplican retención en sus facturas —el 15% estándar o el [7% para autónomos nuevos](/es/blog/guias/retencion-irpf-factura-7-o-15-guia-autonomos/)— esas retenciones se descuentan directamente de lo que pagas en el 130. Ya has "adelantado" IRPF a través de esas retenciones.
...
El Modelo 130 nunca es solo del trimestre. Siempre calculas desde enero y restas lo que ya pagaste. Si te olvidas de esto, pagas de más o de menos, y en cualquier caso te equivocas.
...
La [planificación fiscal desde el primer trimestre](/es/blog/consejos/planificacion-fiscal-primer-trimestre-2026/) te ayuda a anticipar estos importes y no llevarte sorpresas en cada plazo de presentación.
...
<AccordionGroupItem title="¿Cuánto se paga en el Modelo 130?" value="faq-1">

Se paga el **20% del rendimiento neto acumulado** desde el 1 de enero hasta el último día del trimestre, restando las retenciones que te han aplicado tus clientes y los pagos fraccionados ya realizados en trimestres anteriores.

Si Ana tuvo €35.000 de rendimiento neto en el año y pagó €4.780 durante los tres primeros trimestres, en el cuarto trimestre paga €7.000 - €4.780 = €2.220. El 20% siempre se aplica al acumulado anual, no solo al trimestre.

</AccordionGroupItem>

<AccordionGroupItem title="¿Tengo que presentar el Modelo 130 si no he facturado nada?" value="faq-2">

Sí, si estás en estimación directa y no cumples la exención del 70% de retenciones. La obligación de presentar no depende de si tienes ingresos ese trimestre, sino de si cumples los requisitos generales de quien debe presentarlo.

Si no has facturado nada, **el resultado será cero** y no pagarás nada, pero debes presentar el modelo para evitar sanciones. La única forma de no presentarlo es darse de baja como autónomo o acogerse a la exención por retenciones.

</AccordionGroupItem>

<AccordionGroupItem title="¿Qué pasa si el Modelo 130 sale negativo?" value="faq-3">

No pagas nada ese trimestre, pero debes presentar el modelo igualmente. **El saldo negativo no se devuelve**: se traslada automáticamente al siguiente trimestre como parte del cálculo acumulado.

La devolución del IRPF, si corresponde, ocurre en la Declaración de la Renta del año siguiente. Ahí se compara todo lo que adelantaste con lo que realmente debes y Hacienda devuelve el exceso.

</AccordionGroupItem>

<AccordionGroupItem title="¿Quién no tiene que presentar el Modelo 130?" value="faq-4">

Los profesionales (Sección Segunda del IAE) cuyo 70% o más de los ingresos del año anterior ya tenía retención de IRPF practicada por sus clientes. En ese caso, el mecanismo de retenciones ya adelanta suficiente IRPF.

**Importante:** Esta exención solo aplica a profesionales, no a empresarios. Si tu actividad está en la Sección Primera del IAE —comercio, hostelería, construcción, etc.— debes presentar el Modelo 130 siempre, sin excepción.

</AccordionGroupItem>

<AccordionGroupItem title="¿El Modelo 130 se calcula solo del trimestre o del año entero?" value="faq-5">

Del año entero acumulado. En el segundo trimestre calculas tus ingresos y gastos de **enero a junio completo**, aplicas el 20%, y restas lo que ya pagaste en el primer trimestre.

Esto significa que si en el segundo trimestre ganaste menos que en el primero, el resultado puede ser bajo o incluso cero. Es el sistema correcto: el acumulado anual garantiza que siempre adelantas exactamente el 20% de tus beneficios reales hasta ese momento.
...
Invoo registra tus facturas y gastos, calcula automáticamente lo que debes cada trimestre y te avisa cuando se acerca el plazo. Tu gestoría ve los números en tiempo real: sin emails, sin PDFs, sin carreras de último momento. €10.90/mes para autónomos, gratis para gestorías.

**[Apúntate a la lista de espera de Invoo](https://invoo.es)**

Los primeros 100 usuarios tienen un 50% de descuento permanente.
