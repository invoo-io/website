---
title: "Modelo 349: Guía Completa para Autónomos con Clientes UE"
excerpt: "Modelo 349 para autónomos: alta en el ROI, cómo facturar sin IVA y plazos de presentación. Evita sanciones y pierde el miedo a los clientes europeos."
publishedAt: "2026-03-02"
author: "Equipo Invoo"
tags: ["modelo-349", "operaciones-intracomunitarias", "iva", "autonomos", "hacienda", "facturacion-europea"]
readingTime: 9
featured: false
editorPick: true
coverImage: "/blog/modelo-349-operaciones-intracomunitarias-autonomos.webp"
keyTakeaways:
...
sources:
  - name: "AEAT — Registro de Operadores Intracomunitarios (ROI)"
  ...
  - name: "AEAT — Modelo 349: presentación e instrucciones"
    url: "https://sede.agenciatributaria.gob.es/Sede/procedimientoini/GI28.shtml"
  - name: "BOE — Orden EHA/769/2010 (Modelo 349)"
    url: "https://www.boe.es/buscar/act.php?id=BOE-A-2010-5098"
  - name: "VIES — Sistema de intercambio de información sobre IVA"
    url: "https://ec.europa.eu/taxation_customs/vies/"
  - name: "Ley 37/1992 — Ley del Impuesto sobre el Valor Añadido"
    url: "https://www.boe.es/buscar/act.php?id=BOE-A-1992-28740"
lastVerified: "Marzo 2026"
faq:
  - question: "¿Quién está obligado a presentar el Modelo 349?"
    answer: "Deben presentarlo todos los autónomos y empresas que realicen operaciones intracomunitarias: ventas o compras de bienes a empresas de la UE, o prestación y recepción de servicios con empresas de otros Estados miembros. Es obligatorio estar dado de alta en el ROI antes de realizar la primera operación."
  - question: "¿Con qué frecuencia se presenta el Modelo 349: mensual o trimestral?"
    answer: "Por defecto es trimestral, en los mismos plazos que el Modelo 303 (del 1 al 20 de abril, julio, octubre y enero). Pasa a ser mensual si el importe de tus entregas y servicios prestados intracomunitarios supera los 50.000 euros en el trimestre en curso o en cualquiera de los cuatro anteriores. Las adquisiciones no computan para este umbral."
  - question: "¿Cómo facturo a un cliente de la UE sin IVA?"
    answer: "Una vez dado de alta en el ROI, emite la factura a empresas de otros países de la UE sin IVA español. El cliente aplica el IVA de su país (inversión del sujeto pasivo). La factura debe indicar la exención: 'Operación no sujeta a IVA por aplicación de las reglas de localización — Art. 69 Ley 37/1992'."
  - question: "¿Qué sanciones hay por no presentar el Modelo 349?"
    answer: "Si no lo presentas y Hacienda emite requerimiento, la sanción es de 20 euros por dato omitido, con un mínimo de 300 euros y un máximo de 20.000 euros. Si lo presentas voluntariamente fuera de plazo sin requerimiento, la sanción se reduce a la mitad (mínimo 150 euros, máximo 10.000 euros). Si los datos son incorrectos, la sanción es proporcional al importe afectado, con un mínimo de 500 euros. Pero la consecuencia más grave es que Hacienda puede denegar la exención de IVA, obligándote a ingresar el 21% que no cobraste al cliente."
  - question: "¿Las plataformas como Fiverr o Upwork generan obligación de presentar el 349?"
    answer: "Depende del país donde está domiciliada la entidad que te paga, no del cliente final. Si cobras de una entidad con NIF-IVA europeo verificable en VIES, esa operación es intracomunitaria B2B y debes incluirla en el 349. Si cobras de una empresa estadounidense como Upwork, es una exportación fuera de la UE y no va en el 349. Comprueba siempre la entidad facturadora real en tu contrato."
---
...
<WarningCard title="Facturar sin ROI: la trampa más cara">

<p>Si emites facturas intracomunitarias sin estar dado de alta en el ROI, Hacienda puede denegar la exención y exigirte el 21% de IVA sobre todas esas facturas. Como ya las enviaste sin IVA al cliente, ese coste lo absorbes tú. Dependiendo del volumen facturado, puede suponer decenas de miles de euros.</p>
...
Si tienes dudas sobre cómo encajar el 349 en tu [planificación fiscal del primer trimestre](/es/blog/consejos/planificacion-fiscal-primer-trimestre-2026/), ese artículo recoge todos los vencimientos del trimestre de forma cronológica.
...
1. Accede a la [Sede Electrónica de la AEAT](https://sede.agenciatributaria.gob.es/Sede/procedimientoini/GI28.shtml) y busca el Modelo 349.
...
<PullQuote>
<p>La presentación del Modelo 349 es solo la punta del iceberg. El trabajo real está en tener las operaciones bien registradas durante todo el trimestre: NIF-IVA de cada cliente, código de operación, importe y captura de VIES.</p>
</PullQuote>
...
<AccordionGroupItem title="¿Quién está obligado a presentar el Modelo 349?" value="faq-1">

Deben presentarlo todos los autónomos y empresas que realicen operaciones intracomunitarias: ventas o compras de bienes a empresas de la UE, o prestación y recepción de servicios con empresas de otros Estados miembros. Es obligatorio estar dado de alta en el ROI antes de realizar la primera operación.

</AccordionGroupItem>

<AccordionGroupItem title="¿Con qué frecuencia se presenta el Modelo 349: mensual o trimestral?" value="faq-2">

Por defecto es trimestral, en los mismos plazos que el Modelo 303 (del 1 al 20 de abril, julio, octubre y enero). Pasa a ser mensual si el volumen de entregas y servicios intracomunitarios supera los 50.000 euros en el trimestre en curso o en cualquiera de los cuatro anteriores.

</AccordionGroupItem>

<AccordionGroupItem title="¿Cómo facturo a un cliente de la UE sin IVA?" value="faq-3">

Una vez dado de alta en el ROI, emite la factura a empresas de otros países de la UE sin IVA español. El cliente aplica el IVA de su país (inversión del sujeto pasivo). La factura debe indicar: "Operación no sujeta a IVA por aplicación de las reglas de localización — Art. 69 Ley 37/1992".

</AccordionGroupItem>

<AccordionGroupItem title="¿Qué sanciones hay por no presentar el Modelo 349?" value="faq-4">

Si no lo presentas y Hacienda emite requerimiento, la sanción es de 20 euros por dato omitido, con un mínimo de 300 euros y un máximo de 20.000 euros. Si lo presentas voluntariamente fuera de plazo sin requerimiento, la sanción se reduce a la mitad (mínimo 150 euros, máximo 10.000 euros). Si los datos son incorrectos, la sanción es proporcional al importe afectado, con un mínimo de 500 euros. Pero la consecuencia más grave es que Hacienda puede denegar la exención de IVA, obligándote a ingresar el 21% que no cobraste al cliente.

</AccordionGroupItem>

<AccordionGroupItem title="¿Las plataformas como Fiverr o Upwork generan obligación de presentar el 349?" value="faq-5">

Depende del país donde está domiciliada la entidad que te paga, no del cliente final. Si cobras de una entidad con NIF-IVA europeo verificable en VIES, esa operación es intracomunitaria B2B y debes incluirla en el 349. Si cobras de una empresa estadounidense como Upwork, es una exportación fuera de la UE y no va en el 349. Comprueba siempre la entidad facturadora real en tu contrato.
