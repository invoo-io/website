---
title: "Libro de Ingresos y Gastos Autónomos: Guía 2026"
excerpt: "Libro de ingresos y gastos obligatorio para autónomos: qué debe contener, cómo llevarlo correctamente y los 5 errores que disparan inspección de Hacienda."
publishedAt: "2026-02-08"
author: "Equipo Invoo"
tags: ["libro ingresos gastos", "registro facturas", "obligaciones fiscales", "autonomos", "estimacion directa"]
readingTime: 13
featured: false
editorPick: false
coverImage: "/blog/libro-ingresos-gastos-autonomos-obligatorio.webp"
keyTakeaways:
...
faq:
  - question: "¿Es obligatorio llevar el libro de ingresos y gastos si facturo poco?"
    answer: "Depende de tu régimen fiscal. En estimación directa simplificada (la mayoría de autónomos), SÍ es obligatorio independientemente del volumen. En módulos, solo necesitas el libro de bienes de inversión si aplicas amortizaciones."
  - question: "¿Puedo seguir usando Excel para mis libros de registro?"
    answer: "Sí, Excel es legal en 2026. La AEAT incluso ofrece plantillas oficiales. Pero ojo: la mayoría de sanciones a autónomos derivan de errores en libros registro. Un software automatizado reduce ese riesgo drásticamente."
  - question: "¿Verifactu sustituye al libro de ingresos y gastos?"
    answer: "NO. Son dos obligaciones separadas. Verifactu valida tus facturas electrónicas ante Hacienda. Los libros registro documentan tu actividad fiscal. Necesitas ambos tras julio 2027."
  - question: "¿Cuánto tiempo debo conservar los libros de registro?"
    answer: "4 años según la Ley General Tributaria. Pero el Código de Comercio exige 6 años. Recomendamos 6 años para evitar problemas en inspecciones y reclamaciones comerciales."
  - question: "¿Qué multa me pueden poner si no llevo los libros correctamente?"
    answer: "Retraso mayor de 4 meses: €300 fijos. Inexactitud u omisión: 1% de las cantidades omitidas (mínimo €150, máximo €6,000). En SII: 0.5% del importe por factura (€300-€6,000 por trimestre)."
sources:
  - name: "AEAT Sede - Libros Registro IVA"
    url: "https://sede.agenciatributaria.gob.es/Sede/iva/libros-registro.html"
  - name: "BOE - Orden HAC/773/2019 (IRPF, libros registro)"
    url: "https://www.boe.es/buscar/act.php?id=BOE-A-2019-10487"
  - name: "BOE - Real Decreto 1624/1992 (Reglamento IVA, Art. 62-66)"
    url: "https://www.boe.es/buscar/act.php?id=BOE-A-1992-28925"
  - name: "BOE - Ley 58/2003 General Tributaria (Art. 200, sanciones)"
    url: "https://www.boe.es/buscar/act.php?id=BOE-A-2003-23186"
  - name: "AEAT - Verifactu FAQ (diferencia con libros registro)"
...
**Detalle importante:** La "fecha de derecho a deducción" puede ser distinta a la fecha de la factura. Esto ocurre cuando recibes una factura en diciembre pero la operación se realiza en enero. [El criterio de devengo vs. caja](/es/blog/formacion/iva-criterio-caja-vs-devengo-autonomos) afecta aquí.
...
Consulta nuestra guía sobre [rendimientos netos de autónomos](/es/blog/formacion/rendimientos-netos-autonomos-como-calcular) para entender cómo se calcula el beneficio que tributa.
...
Si facturas a clientes internacionales o tienes dudas entre [Modelo 303 vs. 130](/es/blog/guias/modelo-303-vs-modelo-130-guia-autonomos), revisa nuestra guía específica.
...
**Lo que debes saber:** Excel es legal en 2026 para llevar libros registro. La AEAT incluso ofrece [plantillas oficiales en XLS y CSV](https://sede.agenciatributaria.gob.es/Sede/iva/libros-registro.html) descargables desde su web.
...
**Desventajas:**
- Coste mensual (aunque €10.90/mes de [Invoo](https://invoo.es) es menos que una hora de trabajo)
...
**Dato clave:** Verifactu NO sustituye al libro registro. Son dos obligaciones separadas. Pero un software conforme con Verifactu genera ambos automáticamente. [Lee nuestra guía sobre el aplazamiento de Verifactu](/es/blog/guias/verifactu-aplazado-2027-que-cambia-autonomos) para entender las nuevas fechas.
...
Consulta nuestra guía sobre [errores comunes en facturación](/es/blog/consejos/errores-facturacion-autonomos-sanciones-hacienda) para más ejemplos reales.
...
- Usa el criterio de [las 15 deducciones fiscales legales](/es/blog/consejos/15-deducciones-fiscales-autonomos-espana) para saber qué es deducible
...
<AccordionGroupItem title="¿Es obligatorio llevar el libro de ingresos y gastos si facturo poco?" value="faq-1">

Depende de tu régimen fiscal, no del volumen. En estimación directa simplificada (la mayoría de autónomos), SÍ es obligatorio llevar libro de ingresos/ventas, gastos/compras y bienes de inversión independientemente de si facturas €1,000 o €100,000 al año.

En módulos (estimación objetiva), solo necesitas el libro de bienes de inversión si aplicas amortizaciones y quieres deducirlas. Pero todos los sujetos pasivos de IVA deben llevar libros de facturas emitidas y recibidas.

</AccordionGroupItem>

<AccordionGroupItem title="¿Puedo seguir usando Excel para mis libros de registro?" value="faq-2">

Sí, Excel es legal en 2026. La AEAT incluso ofrece plantillas oficiales descargables en XLS y CSV. Pero ojo con los riesgos: la mayoría de sanciones a autónomos derivan de errores en libros registro (numeración correlativa rota, facturas omitidas, cálculos manuales incorrectos).

Un software automatizado elimina el riesgo de error humano, garantiza numeración correlativa, sincroniza con tu gestoría en tiempo real y genera los libros listos para declaración. Por €10.90/mes, es menos que el coste de un solo error.

</AccordionGroupItem>

<AccordionGroupItem title="¿Verifactu sustituye al libro de ingresos y gastos?" value="faq-3">

NO. Son dos obligaciones separadas y ambas seguirán vigentes tras julio 2027. Verifactu es un sistema que valida tus facturas electrónicas ante Hacienda mediante código QR y firma. Los libros registro documentan tu actividad fiscal para calcular IRPF e IVA.

La AEAT ha confirmado oficialmente: "La obligación de elaborar el Libro Registro de Facturas Emitidas sigue vigente, al ser una exigencia distinta." Un software conforme con Verifactu genera automáticamente ambos (validación de facturas + libros registro), pero no puedes prescindir de los libros.

</AccordionGroupItem>

<AccordionGroupItem title="¿Cuánto tiempo debo conservar los libros de registro?" value="faq-4">

La Ley General Tributaria (Art. 29) exige conservar libros y facturas durante 4 años desde la última declaración. Pero el Código de Comercio exige 6 años para documentos comerciales.

Nuestra recomendación: 6 años mínimo. Hacienda puede inspeccionar los últimos 4 años fiscales. Y si hay reclamaciones comerciales con clientes o proveedores, necesitarás documentación completa. En digital no ocupa nada, así que mejor conservar de más que de menos.

</AccordionGroupItem>

<AccordionGroupItem title="¿Qué multa me pueden poner si no llevo los libros correctamente?" value="faq-5">
...
**¿Cansado de perder horas con libros de registro en Excel y temer cada inspección?**

Invoo registra automáticamente cada factura en el libro correspondiente con todos los campos obligatorios. Cálculos de IVA sin errores, numeración correlativa garantizada, y tu gestoría conectada en tiempo real. Verifactu incluido. €10.90/mes para autónomos, gratis para gestorías.
