---
title: "Trabajar Desde Casa como Autónomo: Qué Deducir en 2026"
excerpt: "Luz, agua, internet, alquiler... ¿Cuánto puedes deducir trabajando desde casa? Te explicamos la regla del 30%, cómo calcularla y qué necesitas guardar."
publishedAt: "2026-02-11"
author: "Equipo Invoo"
tags: ["gastos deducibles", "teletrabajo", "autonomos", "irpf", "modelo 036"]
readingTime: 12
featured: false
editorPick: false
coverImage: "/blog/trabajar-desde-casa-autonomo-deducciones-2026.webp"
keyTakeaways:
...
faq:
  - question: "¿Qué es la regla del 30% para autónomos?"
    answer: "Es el coeficiente que la Ley del IRPF permite aplicar a la proporción de tu vivienda afecta a la actividad para deducir suministros. Fórmula correcta: (m² despacho / m² totales) × 30% × factura. Un error común es aplicar 30% directamente al total."
  - question: "¿Puedo deducir el IVA de los suministros además del IRPF?"
    answer: "Sí. Desde julio 2025, el Tribunal Supremo confirmó que el IVA de suministros de vivienda afecta es deducible. Se calcula SIN el coeficiente del 30%: (m² despacho / m² totales) × IVA de la factura."
  - question: "¿Las facturas de suministros tienen que estar a mi nombre?"
    answer: "Sí, deben estar a tu nombre o al de tu cónyuge si estás en régimen de gananciales. Facturas a nombre de terceros no son válidas como justificante fiscal ante Hacienda."
  - question: "¿Qué documentación necesito para justificar las deducciones?"
    answer: "Modelo 036 con domicilio declarado, facturas completas con NIF, contratos de suministros a tu nombre, plano o fotos del espacio con cálculo de m², y hojas de cálculo que muestren las proporciones aplicadas."
  - question: "¿Puedo deducir gastos si trabajo desde casa pero no tengo un despacho exclusivo?"
    answer: "Solo si puedes demostrar que una parte de la vivienda está afecta de forma regular a tu actividad. Hacienda no exige una habitación con puerta cerrada, pero sí uso profesional demostrable y diferenciado del uso personal."
sources:
  - name: "BOE - Ley 6/2017: Modificación artículo 30.2.5ª.b) LIRPF (regla 30%)"
    url: "https://www.boe.es/buscar/act.php?id=BOE-A-2017-12207"
  - name: "AEAT - Manual Práctico IRPF: Gastos de suministros en vivienda"
  ...
  - name: "Tribunal Supremo - Sentencia 15 julio 2025: IVA deducible en suministros de vivienda afecta"
    url: "https://www.poderjudicial.es/search/AN/openDocument/cd87a5c32e8e9073/20250715"
  - name: "TEAC - Resolución 00/06654/2022 (19 julio 2023): Criterio unificado IVA suministros"
    url: "https://petete.tributos.hacienda.gob.es/consultas/"
  - name: "TSJM - Sentencia 22 septiembre 2025: IVA exento alquiler no impide deducción IRPF"
    url: "https://www.poderjudicial.es/"
  - name: "AEAT - Guía del modelo 036: Casillas para declarar vivienda afecta"
    url: "https://sede.agenciatributaria.gob.es/Sede/censos-nif-domicilio-fiscal/alta-modificacion-baja-censo-empresarios/modelo-036-declaracion-censal.html"
...
La Ley del IRPF permite deducir **el 30% de la proporción de tu vivienda afecta a la actividad** para calcular gastos de suministros. Esta norma entró en vigor el 1 de enero de 2018 con la [Ley 6/2017](https://www.boe.es/buscar/act.php?id=BOE-A-2017-12207).
...
<WarningCard title="Importante para inspección">
...
Proporción de vivienda: 20 m² / 100 m² = 20%
Aplicar coeficiente del 30%: 20% × 30% = 6%
Gasto deducible: 6% × €66,12 = **€3,97 mensuales** (€47,64 anuales)
...
Entra en la [Sede Electrónica de la AEAT](https://sede.agenciatributaria.gob.es) y descarga tu modelo 036 activo. Comprueba:

**Casilla 111 (Domicilio):** Debe aparecer tu dirección como lugar de actividad.
**Casilla 423 (Afectación):** Debe indicar el porcentaje (14% en nuestro ejemplo) o marcar "Sí" si es la versión simplificada.
...
IRPF: 14% × 30% × €57,85 = **€2,43/mes** → €29,16 anuales
IVA: 14% × €12,15 = **€1,70/mes** → €20,40 anuales

**Factura de agua: €35 mensuales (base €28,93 + IVA €6,07)**

IRPF: 14% × 30% × €28,93 = **€1,21/mes** → €14,52 anuales
IVA: 14% × €6,07 = **€0,85/mes** → €10,20 anuales

**Factura de internet: €45 mensuales (base €37,19 + IVA €7,81)**

IRPF: 14% × 30% × €37,19 = **€1,56/mes** → €18,72 anuales
IVA: 14% × €7,81 = **€1,09/mes** → €13,08 anuales
...
Para entender cómo estos gastos reducen tu base imponible del IRPF, consulta nuestra guía sobre [cómo calcular rendimientos netos de autónomos](/es/blog/formacion/rendimientos-netos-autonomos-como-calcular). Y si necesitas registrar estos gastos correctamente en tus libros obligatorios, lee la guía del [libro de ingresos y gastos para autónomos](/es/blog/guias/libro-ingresos-gastos-autonomos-obligatorio).
...
Si necesitas presentar modificaciones al modelo 036 porque cambiaste de domicilio o nunca declaraste la afectación, hazlo ahora. No es complicado, pero es absolutamente crítico. Para evitar otros [errores comunes de facturación que generan sanciones](/es/blog/consejos/errores-facturacion-autonomos-sanciones-hacienda), revisa tu configuración fiscal completa al menos una vez al año.

Y si estás valorando diferentes gastos deducibles más allá de tu vivienda, consulta la [lista completa de gastos deducibles para autónomos en 2026](/es/blog/guias/gastos-deducibles-autonomos-2026-lista-completa) para maximizar tu optimización fiscal.

## Preguntas frecuentes

<AccordionGroup>

<AccordionGroupItem title="¿Qué es la regla del 30% para autónomos?" value="faq-1">

Es el coeficiente que la Ley del IRPF (artículo 30.2.5ª.b), modificada por la Ley 6/2017, permite aplicar a la proporción de tu vivienda afecta a la actividad para calcular la deducción de suministros. La fórmula correcta es: (m² de tu despacho / m² totales de vivienda) × 30% × importe de la factura. Un error común es aplicar el 30% directamente al total de la factura, lo cual es incorrecto y puede ser rechazado en inspección. La norma entró en vigor en enero de 2018.

</AccordionGroupItem>

<AccordionGroupItem title="¿Puedo deducir el IVA de los suministros además del IRPF?" value="faq-2">

Sí. Desde julio de 2025, el Tribunal Supremo (sentencia de 15 de julio de 2025) confirmó que el IVA de suministros de vivienda afecta a la actividad es deducible. Esto unificó un criterio que había generado confusión durante años. La clave: el IVA se calcula SIN aplicar el coeficiente del 30%. Fórmula: (m² despacho / m² totales) × IVA de la factura. Ejemplo: 20% de vivienda afecta, factura con €12 de IVA → deduces €2,40 de IVA trimestralmente. La TEAC estableció este criterio en julio de 2023 (Resolución 00/06654/2022).

</AccordionGroupItem>

<AccordionGroupItem title="¿Las facturas de suministros tienen que estar a mi nombre?" value="faq-3">

Sí, obligatoriamente deben estar a tu nombre (tu NIF como titular) o al nombre de tu cónyuge si estás casado en régimen de gananciales. Facturas a nombre de otras personas (padres, hermanos, amigos, pareja no casada) no son válidas como justificante fiscal ante Hacienda. Si vives en una vivienda donde los contratos están a nombre de otra persona, debes cambiar la titularidad de los contratos a tu nombre para poder deducir los suministros. Los contratos de servicios también deben coincidir con los datos de las facturas.

</AccordionGroupItem>

<AccordionGroupItem title="¿Qué documentación necesito para justificar las deducciones?" value="faq-4">

Necesitas cinco elementos documentales: 1) Modelo 036 con tu domicilio declarado como lugar de actividad (casilla 111) y grado de afectación (casilla 423). Sin esto, Hacienda rechaza automáticamente todo. 2) Facturas completas de todos los suministros con tu NIF y todos los datos fiscales. 3) Contratos de suministros a tu nombre como titular. 4) Plano catastral o fotos con medidas que demuestren los metros cuadrados de tu despacho. 5) Hoja de cálculo con el desglose mensual mostrando cómo aplicaste la fórmula. Conserva todo durante 6 años mínimo.

</AccordionGroupItem>

<AccordionGroupItem title="¿Puedo deducir gastos si trabajo desde casa pero no tengo un despacho exclusivo?" value="faq-5">

Sí, puedes deducir siempre que puedas demostrar que una parte de tu vivienda está afecta de forma regular y habitual a tu actividad profesional. Hacienda no exige legalmente que sea una habitación cerrada con puerta exclusiva, pero sí requiere que el uso profesional sea demostrable y diferenciado del uso personal. Por ejemplo, si trabajas en una mesa en el salón, puedes deducir los metros cuadrados de esa zona específica (mesa + silla + espacio de movimiento). La clave es poder justificar en inspección que ese espacio tiene uso profesional regular, no ocasional.
...
**¿Quieres deducir sin errores y sin quebraderos de cabeza?**

Empieza con una facturación ordenada desde el primer día. Invoo registra cada factura que emites y tu gestoría lo ve al instante. Cuando llegue el momento de calcular deducciones, tu asesor tiene todos tus ingresos organizados sin perseguirte por email. Cumplimiento Verifactu incluido. €10.90/mes para autónomos, dashboard gratuito para gestorías.
