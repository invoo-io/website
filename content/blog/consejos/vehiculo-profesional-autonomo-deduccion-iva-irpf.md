...
featured: false
editorPick: false
coverImage: "/blog/vehiculo-profesional-autonomo-deduccion-iva-irpf.webp"
keyTakeaways:
...
sources:
  ...
  - name: "Art. 29 Ley 35/2006 del IRPF — BOE"
    url: "https://www.boe.es/buscar/act.php?id=BOE-A-2006-20764"
  - name: "Resolución TEAC 00/04214/2024 de 24/06/2025"
    url: "https://serviciostelematicosext.hacienda.gob.es/TEAC/DYCTEA/criterio.aspx?id=00/04214/2024/00/0/1"
  - name: "AEAT — Coeficientes de amortización lineal IRPF"
  ...
  - name: "IRPF y vehículos mixtos: postura del TEAC — Consejo de Gestores"
    url: "https://www.consejogestores.org/noticias/deducibilidad-vehiculos-mixtos-irpf/"
...
<WarningCard title="El error que más cuesta">
...
<WarningCard title="Consulta con tu gestoría">
...
<AccordionGroupItem title="¿Cuánto IVA puede deducir un autónomo por su coche?" value="faq-1">

El punto de partida es el **50% sin necesidad de demostrar nada**, gracias a la presunción legal del Art. 95.3 de la Ley del IVA. Esta presunción aplica a turismos, motocicletas y ciclomotores. Si Hacienda quiere reducirte por debajo del 50%, es ella quien carga con la prueba. Puedes llegar al **100%** si tu actividad está en la lista cerrada: transporte de mercancías, taxi, VTC, autoescuela, agentes comerciales, o servicios de vigilancia. El porcentaje elegido se aplica tanto al vehículo como a todos sus gastos asociados: combustible, reparaciones, peajes y parking.

</AccordionGroupItem>

<AccordionGroupItem title="¿Puedo deducir el coche en IRPF si lo uso también para fines personales?" value="faq-2">

En general, no. El IRPF exige uso exclusivo profesional para que un turismo sea deducible como elemento afecto a la actividad. No existe un porcentaje proporcional para vehículos de uso mixto en IRPF. Algunos asesores aplican el criterio de **0,26€/km por desplazamiento profesional**, pero su base legal para autónomos no está consolidada (la norma de origen regula dietas de empleados por cuenta ajena). Lo que sí es defendible es deducir los gastos reales documentados de tus desplazamientos profesionales con un registro detallado de cada trayecto. Consulta con tu gestoría.
...
<AccordionGroupItem title="¿Compensa más el renting o la compra del coche para autónomos?" value="faq-4">

Depende de si el vehículo califica para deducción en IRPF. Si el vehículo es exclusivamente profesional, **el renting suele generar mayor deducción anual**: deduces la cuota completa como gasto corriente (por ejemplo, €4.800/año en un renting de €400/mes), mientras que con la compra solo amortizas el 16% anual del coste (€3.840 sobre €24.000). Si el vehículo no califica para IRPF —porque es de uso mixto— la diferencia entre renting y compra es solo en el IVA de las cuotas, que sigue el mismo criterio del 50%. En ese escenario, la decisión se basa en liquidez y preferencia de gestión, no en ventaja fiscal.
...
**¿Tu gestoría tiene que pedirte los datos del coche cada trimestre?**

Con Invoo, tu asesor ve tus facturas en tiempo real — sin que tengas que enviarle nada. Tú facturas, ellos lo ven al instante. Software de facturación para autónomos con tu gestoría conectada de serie. €10,90/mes para autónomos, gratis para gestorías.
