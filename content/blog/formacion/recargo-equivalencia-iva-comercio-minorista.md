---
title: "Recargo de Equivalencia: Qué Es, Tipos y Obligados"
excerpt: "El recargo de equivalencia sustituye tu IVA trimestral. Descubre quién está obligado, los tipos (5,2%, 1,4%, 0,5%) y cómo afecta a tus facturas como minorista."
publishedAt: "2026-02-20"
author: "Equipo Invoo"
tags: ["recargo-de-equivalencia", "iva-autonomos", "comercio-minorista", "regimen-especial-iva", "facturacion-autonomos"]
readingTime: 11
featured: false
editorPick: true
coverImage: "/blog/recargo-equivalencia-iva-comercio-minorista.webp"
keyTakeaways:
...
sources:
  - name: "AEAT - Régimen especial del recargo de equivalencia"
    url: "https://sede.agenciatributaria.gob.es/Sede/iva/regimenes-tributacion-iva/regimen-especial-recargo-equivalencia.html"
  - name: "BOE - Ley 37/1992, del IVA (artículos 148-163)"
    url: "https://www.boe.es/buscar/act.php?id=BOE-A-1992-28740"
  - name: "AEAT - Tipos del recargo de equivalencia"
    url: "https://sede.agenciatributaria.gob.es/Sede/ayuda/manuales-videos-folletos/manuales-practicos/manual-iva-2024/capitulo-06-regimenes-especiales-iva/regimen-especial-recargo-equivalencia/tipos-recargo-equivalencia.html"
  - name: "AEAT - Obligaciones de facturación en recargo de equivalencia"
...
faq:
  - question: "¿Qué es el recargo de equivalencia?"
    answer: "Es un régimen especial de IVA diseñado para simplificar la tributación de los comerciantes minoristas. En lugar de gestionar el IVA trimestral, tu proveedor te aplica un porcentaje adicional sobre el precio de compra que ya incluye el IVA que deberías haber ingresado a Hacienda por tus ventas."
  - question: "¿Tengo que presentar el Modelo 303 si estoy en recargo de equivalencia?"
    answer: "No, con carácter general. Las ventas en recargo de equivalencia están exoneradas de la autoliquidación trimestral de IVA (Modelo 303). Sin embargo, si realizas otras actividades fuera del régimen o tienes adquisiciones intracomunitarias, sí deberás presentarlo por esas operaciones."
  - question: "¿Puedo deducir el IVA si estoy en recargo de equivalencia?"
    answer: "No puedes deducir el IVA como tal, porque no eres el responsable de su gestión ante Hacienda. Sin embargo, el recargo de equivalencia que pagas a tu proveedor forma parte del coste de tus compras, y ese coste total (IVA + recargo) sí es deducible como gasto en tu declaración de IRPF."
  - question: "¿Los comerciantes en recargo de equivalencia tienen que cumplir Verifactu?"
    answer: "En general, los minoristas en recargo de equivalencia no están obligados a emitir factura completa por sus ventas a consumidores finales. Pero si emites facturas (a empresas, a la administración pública, o a petición del cliente), el software que uses debe ser Verifactu-conforme antes del 1 de julio de 2027."
  - question: "¿Puedo salir del recargo de equivalencia?"
    answer: "El régimen es obligatorio e irrenunciable mientras sigas siendo un comerciante minorista persona física. Puedes salir si constituyes una Sociedad Limitada (ya que el recargo solo aplica a personas físicas y comunidades de bienes), si más del 20% de tus ventas son a otras empresas (pierdes la condición de minorista), o si fabricas o transformas los productos que vendes."
---
...
<WarningCard title="El régimen es obligatorio: no puedes renunciarlo">
...
Tampoco presentas el Modelo 390 (resumen anual de IVA) por tus ventas minoristas. Si quieres profundizar en la diferencia entre el Modelo 303 y el Modelo 130, y cuándo aplica cada uno, consulta nuestra guía sobre [la diferencia entre el Modelo 303 y el Modelo 130 para autónomos](/es/blog/guias/modelo-303-vs-modelo-130-guia-autonomos/).

### Tus obligaciones en IRPF y libros de registro

Estar en recargo de equivalencia no te exonera del IRPF. **Sigues declarando todos tus ingresos y gastos** en tu declaración anual. Y sigues obligado a llevar el [libro de ingresos y gastos](/es/blog/guias/libro-ingresos-gastos-autonomos-obligatorio/) como cualquier autónomo en estimación directa.
...
Para conocer todos los gastos que puedes deducir como autónomo en estimación directa, consulta nuestra [lista completa de gastos deducibles para autónomos en 2026](/es/blog/guias/gastos-deducibles-autonomos-2026-lista-completa/).
...
En esa factura no desglosarás el recargo de equivalencia: el recargo ya fue gestionado por tu proveedor. Tus facturas al cliente muestran el precio del producto con el IVA correspondiente, como cualquier otro comercio. El recargo no aparece en tus ventas. Consulta los requisitos exactos en nuestra guía sobre [la factura simplificada y sus requisitos](/es/blog/formacion/factura-simplificada-requisitos-limite-400/).

Si vendes a otras empresas o profesionales (y eso no supera el 20% de tu facturación), esas facturas sí requieren el formato completo. Y si alguna vez tienes dudas sobre si estás cometiendo algún [error de facturación que puede sancionarte Hacienda](/es/blog/consejos/errores-facturacion-autonomos-sanciones-hacienda/), revisa esa guía antes de emitir facturas problemáticas.
...
Otra opción es constituir una Sociedad Limitada. Las SL no pueden estar en recargo de equivalencia, por lo que pasarías a tributar en régimen general de IVA. Esto te daría control completo sobre la gestión del impuesto, a cambio de mayor carga administrativa. Si estás valorando ese paso, consulta nuestro análisis comparativo sobre [autónomo vs Sociedad Limitada en 2026](/es/blog/analisis/autonomo-vs-sociedad-limitada-2026/).
...
<AccordionGroupItem title="¿Qué es el recargo de equivalencia?" value="faq-1">

Es un régimen especial de IVA diseñado para simplificar la tributación de los comerciantes minoristas personas físicas. En lugar de gestionar el IVA trimestral, tu proveedor te aplica un porcentaje adicional sobre el precio de compra que ya incluye el IVA que corresponde a tus futuras ventas al público. Hacienda recauda el IVA de forma anticipada a través del proveedor, y tú quedas exonerado de autoliquidarlo.

</AccordionGroupItem>

<AccordionGroupItem title="¿Tengo que presentar el Modelo 303 si estoy en recargo de equivalencia?" value="faq-2">

No, con carácter general. Las ventas en recargo de equivalencia están exoneradas de la autoliquidación trimestral de IVA mediante el Modelo 303. Sin embargo, si realizas otras actividades fuera del régimen (servicios, ventas a empresas que superen el 20% de tu facturación) o tienes adquisiciones intracomunitarias, sí deberás presentarlo por esas operaciones concretas. La exoneración es solo para las ventas minoristas incluidas en el régimen.

</AccordionGroupItem>

<AccordionGroupItem title="¿Puedo deducir el IVA si estoy en recargo de equivalencia?" value="faq-3">

No puedes deducir el IVA como tal, porque en este régimen no eres el responsable de gestionarlo ante Hacienda: es el proveedor quien lo hace. Sin embargo, el recargo de equivalencia que pagas —y el propio IVA incluido en tus compras— forma parte del coste de tus mercancías. Ese coste total sí es deducible como gasto en tu declaración de IRPF, lo que reduce tu base imponible y compensa parcialmente el pago del recargo.

</AccordionGroupItem>

<AccordionGroupItem title="¿Los comerciantes en recargo de equivalencia tienen que cumplir Verifactu?" value="faq-4">

En general, los minoristas en recargo de equivalencia no están obligados a emitir factura completa por sus ventas a consumidores finales, por lo que la obligación de Verifactu no les aplica para esas operaciones. Pero si emites facturas completas —a empresas, a la administración pública, o a petición del cliente— el software que uses para emitirlas debe ser Verifactu-conforme antes del 1 de julio de 2027 (plazo para autónomos). Si quieres entender bien cómo te afecta, consulta nuestra [guía completa de Verifactu para autónomos y pymes](/es/blog/guias/verifactu-2025-2026-guia-completa-autonomos-pymes/).

</AccordionGroupItem>

<AccordionGroupItem title="¿Puedo salir del recargo de equivalencia?" value="faq-5">

El régimen es obligatorio e irrenunciable mientras sigas cumpliendo los requisitos de comerciante minorista persona física. Las vías de salida son: constituir una Sociedad Limitada (las SL no pueden estar en este régimen), conseguir que más del 20% de tus ventas sean a otras empresas o profesionales (pierdes la condición de minorista), o comenzar a fabricar o transformar los productos que vendes. Cualquiera de estos cambios debe declararse en el Modelo 036.
...
**¿Quieres llevar tu facturación de comercio minorista sin complicaciones?**

Invoo te ayuda a emitir facturas correctas como comerciante minorista y mantiene tus libros de registro actualizados. Tu gestoría lo ve todo en tiempo real, sin emails con PDFs. €10.90/mes para autónomos, gratis para gestorías.

Los primeros 100 usuarios ahorran un 50% para siempre.
