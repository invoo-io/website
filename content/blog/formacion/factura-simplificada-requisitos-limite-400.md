...
author: "Equipo Invoo"
tags: ["factura simplificada", "requisitos facturación", "verifactu", "autónomos", "iva"]
readingTime: 11
featured: false
editorPick: true
coverImage: "/blog/factura-simplificada-requisitos-limite.webp"
keyTakeaways:
...
sources:
  - name: "AEAT - Tipos de factura"
    url: "https://sede.agenciatributaria.gob.es/Sede/iva/facturacion-registro/facturacion-iva/tipos-factura.html"
  ...
  - name: "BOE - Real Decreto 1007/2023 (Verifactu)"
    url: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2023-24840"
...
faq:
  - question: "¿Cuál es el límite de una factura simplificada?"
    answer: "El límite general es 400€ (IVA incluido). En hostelería, retail y transporte puede ser hasta 3.000€."
  - question: "¿Puedo deducir el IVA de una factura simplificada?"
    answer: "No, salvo que incluya tus datos fiscales completos (NIF, domicilio y cuota de IVA desglosada)."
  - question: "¿Qué datos debe llevar una factura simplificada?"
    answer: "NIF del emisor, nombre completo, número correlativo, fecha, descripción, tipo de IVA, importe total (IVA incluido) y menciones específicas cuando proceda."
  - question: "¿Las facturas simplificadas deben cumplir Verifactu?"
    answer: "Sí. Desde enero 2027 (sociedades) o julio 2027 (autónomos), las facturas simplificadas emitidas con software deberán incluir código QR y cumplir Verifactu."
---
...
<WarningCard title="Cuidado con los importes mixtos">
...
No necesitas incluir domicilio propio (aunque es recomendable). Tampoco necesitas desglosar base imponible y cuota de IVA por separado. Si quieres evitar problemas con los datos, consulta los [10 errores de facturación que Hacienda sanciona](/es/blog/consejos/errores-facturacion-autonomos-sanciones-hacienda).
...
En la práctica, muchos autónomos emiten directamente factura completa en operaciones B2B. Es más seguro y evita confusiones. Si te interesa la diferencia con otros documentos previos a la factura, lee nuestra guía sobre [factura proforma vs presupuesto](/es/blog/formacion/factura-proforma-vs-presupuesto-diferencias).
...
La buena noticia: si usas software actualizado y conforme antes de julio 2027, **no tendrás que hacer nada manualmente**. El sistema genera el QR, la etiqueta y el hash automáticamente. Lee nuestra [guía completa para cumplir Verifactu sin complicaciones](/es/blog/guias/verifactu-2025-2026-guia-completa-autonomos-pymes).
...
<AccordionGroupItem title="¿Cuál es el límite de una factura simplificada?" value="faq-1">

El límite general es **400€ IVA incluido**. Pero si tu actividad está en la lista de 14 sectores específicos (ventas al por menor, hostelería, transporte de personas, peluquerías, parkings, tintorerías, autopistas de peaje, salas de baile, instalaciones deportivas, revelado de fotos, alquiler de películas, venta ambulante, venta a domicilio), puedes emitir facturas simplificadas hasta **3.000€ IVA incluido**.

Si tu actividad no está en esa lista, tu límite es 400€ aunque vendas directamente a consumidor final.

</AccordionGroupItem>

<AccordionGroupItem title="¿Puedo deducir el IVA de una factura simplificada?" value="faq-2">

**Por defecto, no**. La factura simplificada básica no permite la deducción de IVA porque no incluye los datos fiscales del destinatario ni desglosa la cuota tributaria.

Sin embargo, existe una excepción: si el emisor incluye voluntariamente tu NIF, tu domicilio fiscal y la cuota de IVA desglosada (no solo el total), entonces **sí puedes deducir el IVA** aunque sea factura simplificada.

En la práctica, cuando necesites deducir IVA, pide directamente factura completa al proveedor. Es más seguro y evita confusiones.

</AccordionGroupItem>

<AccordionGroupItem title="¿Qué datos debe llevar una factura simplificada?" value="faq-3">

**Los nueve datos obligatorios** según el Reglamento de Facturación son:

1. Número y serie correlativa
2. Fecha de expedición
3. Fecha de realización (solo si es diferente)
4. NIF del emisor
5. Nombre completo del emisor
6. Descripción de la operación (qué has vendido o prestado)
7. Tipo impositivo de IVA aplicado (puede ser solo "IVA incluido")
8. Contraprestación total (importe con IVA incluido)
9. Menciones específicas cuando proceda (exenciones, régimen especial, etc.)

Si falta alguno de estos datos, la factura puede considerarse nula y Hacienda puede sancionar por incumplimiento del Reglamento de Facturación.

</AccordionGroupItem>

<AccordionGroupItem title="¿Las facturas simplificadas deben cumplir Verifactu?" value="faq-4">

**Sí, desde julio 2027** para autónomos personas físicas (desde enero 2027 para sociedades). Si emites facturas simplificadas con software de facturación, TPV o cualquier sistema informático, deberán incluir:

- Código QR verificable en la web de la AEAT
- Etiqueta "VERI*FACTU" visible
- Huella digital encadenada con la factura anterior

La única excepción son las facturas simplificadas emitidas **completamente a mano** en papel o con Word sin sistema de encadenamiento. Pero perderás las ventajas de automatización, seguimiento y control de errores que ofrece el software conforme.
...
**¿Quieres facturar sin preocuparte por el formato?**

Invoo detecta automáticamente si necesitas factura simplificada o completa, cumpliendo Verifactu desde el primer día. Y tu gestoría ya tiene acceso directo para revisarlo todo. Sin errores, sin complicaciones.
